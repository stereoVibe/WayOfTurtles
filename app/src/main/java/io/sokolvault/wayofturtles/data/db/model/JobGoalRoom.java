...
//        foreignKeys = @ForeignKey(entity = CompositeGoalRoom.class,
...
//public class JobGoalRoom extends Goal implements Internable {
//
...
//
//    public JobGoalRoom(int id, String title, int mCompositeGoalID){
//        super(title);
//        this.id = id;
...
//
//    @Ignore
//    public JobGoalRoom(int id, int mCompositeGoalID, String title, int mTasksQuantity) {
//        super(title);
//        this.id = id;
//        this.mCompositeGoalID = mCompositeGoalID;
...
//
//    @Ignore
//    private JobGoalRoom(Builder builder) {
//        super(builder.title);
//        setId(builder.id);
...
//        }
//
//        public JobSubGoalRoom build() {
//            return new JobSubGoalRoom(this);
//        }
//    }
//}
